                            ...
                            <tr>
                                <th scope="row">
                                    <div class="d-flex align-items-center">
                                        <img src="/{{$cart->type=='juice'?'storage/'.$cart->juice->image_path:$cart->product->cover}}" class="img-fluid me-5 rounded" style="width: 80px; height: 80px;" alt="">
                                    </div>
                                </th>
                                <td>
                                    <p class="mb-0 mt-4">{{$cart->type=='juice'?$cart->juice->size.'ml '.$cart->juice->flavour->name . ' juice':$cart->product->name}}</p>
                                </td>
                                <td>
                                    <p class="mb-0 mt-4">{{$cart->type=='juice'?$cart->juice->price:$cart->product->price}}</p>
                                </td>
                                <td>
                                ...
                                <td>
                                    <p class="mb-0 mt-4">{{($cart->type=='juice'?$cart->juice->price:$cart->product->price)*($cart->quantity)}}</p>
                                </td>
                                <td>
